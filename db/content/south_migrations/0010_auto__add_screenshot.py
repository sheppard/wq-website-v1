...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'content_screenshot', (
            ...
            ('example', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content.Example'])),
        ))
        db.send_create_signal(u'content', ['ScreenShot'])


    def backwards(self, orm):
        # Deleting model 'ScreenShot'
        db.delete_table(u'content_screenshot')
