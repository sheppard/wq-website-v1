...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Example.db_version'
        # db.delete_column(u'content_example', 'db_version')

        # Deleting field 'Example.icon_url'
        # db.delete_column(u'content_example', 'icon_url')

        # Deleting field 'Example.io_version'
        # db.delete_column(u'content_example', 'io_version')

        # Deleting field 'Example.app_version'
        # db.delete_column(u'content_example', 'app_version')

        # Deleting field 'Example.vera_version'
        # db.delete_column(u'content_example', 'vera_version')

        # Deleting field 'Example.api_version'
        # db.delete_column(u'content_example', 'api_version')

        # Adding field 'Example.icon'
        db.add_column(u'content_example', 'icon',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Example.db_version'
        db.add_column(u'content_example', 'db_version',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Example.icon_url'
        db.add_column(u'content_example', 'icon_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Example.io_version'
        db.add_column(u'content_example', 'io_version',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Example.app_version'
        db.add_column(u'content_example', 'app_version',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Example.vera_version'
        db.add_column(u'content_example', 'vera_version',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Example.api_version'
        db.add_column(u'content_example', 'api_version',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Example.icon'
        db.delete_column(u'content_example', 'icon')
    ...
    models = {
        ...
        u'content.screenshot': {
            'Meta': {'object_name': 'ScreenShot'},
            'example': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.Example']"}),
